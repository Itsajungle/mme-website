...
export async function POST(request: Request) {
  try {
    ...
    const { script, brandSlug, voiceId, format, imagePrompt } = body;
    ...
    // Attempt to generate the visual
    ...
    // Attempt to generate the voiceover
    ...
    // Estimate duration from word count (~130 words per minute)
