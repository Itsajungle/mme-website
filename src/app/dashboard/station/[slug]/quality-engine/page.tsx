...
import { QualityEngineDashboard } from "@/components/quality-engine/QualityEngineDashboard";

export default function QualityEnginePage({ params }: { params: Promise<{ slug: string }> }) {
